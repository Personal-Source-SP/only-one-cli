...
Rule: The `init` command SHALL support initializing a project using one or more predefined configuration combos. Tool selection (Step 1) is always run.
...
- **AND** it displays the pre-execution summary showing the merged contents
