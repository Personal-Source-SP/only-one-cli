...
- [x] 3.4 Add fault-injection tests for settings failure, extension install failure, termination, interrupted process recovery, and failed recovery blocking new changes
...
- [x] 4.4 Add command tests for multi-editor selection, platform paths, merge precedence, unselected editors, progress, and rollback
...
- [x] 5.4 Add command tests for multiple editors, missing CLI, duplicate IDs, install progress, partial failure, and compensating uninstall
...
- [x] 6.4 Manually smoke-test both commands on available editors and confirm interrupted-run recovery restores pre-run state
