...
export const COMBOS: ComboManifest[] = [
    {
        ...
        skills: ['c4-diagrams', 'gherkin-authoring', 'grill-me', 'only-one-nextjs-development', 'ux-flow-designer'],
    ...
    },
    {
        ...
        skills: ['c4-diagrams', 'gherkin-authoring', 'grill-me', 'only-one-nestjs-development', 'system-design'],
